...
function woothemes_more_themes_page(){
       ...
       //global $options, $themename, $manualurl;
        ...
        <div class="wrap">
          <h2>Больше тем от WooThemes</h2>
          <div class="info">
          <a href="http://www.woothemes.com/the-woothemes-club/">Присоедениться к клубу WooThemes</a> / <a href="http://www.woothemes.com/category/themes/">Галерея тем</a> / <a href="http://showcase.woothemes.com/">Предпросмотр тем</a>
          </div>
